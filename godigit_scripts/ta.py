...
from godigit_bs4_scraper import parse_comprehensive_plan_footer, scrape_idv_block, scrape_plan_card, scrape_policy_durations ,scrape_plan_info
from test import  extract_cost_breakup_from_html, parse_addon_pack, parse_popular, parse_popular_pack, parse_trust_card_numbers_only , extract_policy_durations, extract_addon_names, extract_ncb_percentage_and_value, extract_extra_addons
# from test import extract_cost_breakup_from_html, parse_addon_pack, parse_popular, parse_popular_pack, parse_trust_card_numbers_only , extract_policy_durations, extract_addon_names, extract_ncb_percentage_and_value, extract_extra_addons
